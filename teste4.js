(function () {
    ...
    container.style.zIndex = '10000'; // Valor alto para o contêiner
    ...
    expansion.style.zIndex = '9999'; // Certificando-se de que o expansion fica acima do fundo
    ...
    button.style.zIndex = '10000'; // Garantindo que o botão está acima de qualquer outro conteúdo
    ...
    function showModal() {
        ...
        document.getElementById('contact-form').addEventListener('submit', async (e) => {
            ...
            try {
                const apiUrl = 'https://api.clicki9.com';
